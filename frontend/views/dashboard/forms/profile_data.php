    ...
    <div class="row">
        <div class="col-sm-6">
            ...
            echo $form->field($model->getModel('profile'), 'city_id')->widget(DepDrop::classname(), [
                'data' =>$model->getModel('profile')->state_id ?  \yii\helpers\ArrayHelper::map(\backend\models\Cities::find()->where(['state_id'=>$model->getModel('profile')->state_id])->all(), 'id', 'title') : [],
