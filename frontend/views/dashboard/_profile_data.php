        ...
        <div class="profile_info">
            ...
            <div class="profile_info_complation"> 
                <div class="profile_complete_progress">
                    <div class="progress">
                        <div class="progress-bar progress-bar-yellow" role="progressbar" style="width: <?= $profile->profile_percentage ?>%;" aria-valuenow="<?= $profile->profile_percentage ?>" aria-valuemin="0" aria-valuemax="100"><?= $profile->profile_percentage ?>%</div>
                    </div>
                    <div class="text-right mrsm text-muted"><small><?php echo Yii::t('frontend','Your Profile is'); ?> <?= $profile->profile_percentage ?>% <?php echo Yii::t('frontend','complete'); ?></small></div>
                </div>
