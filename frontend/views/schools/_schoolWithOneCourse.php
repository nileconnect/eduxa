...
<div class="item">
    <header class="item-header">
        <figure>
            ...
            <a href="/school/<?= $course->school->slug?>"> 
                <img src="<?= $course->school->logoImage?>" alt="<?= $course->school->title ?>" height="193px" width="310px">
            </a>
        </figure>
        <div class="item-content">
            <div class="item-name">
                <a href="/school/<?= $course->school->slug?>"><span> <?= $course->school->title ?> - <?= $course->title ?></span></a>
                <div class="rating">
            ...
            <div class="item-body">
                <?= $course->school->details ; ?>
            </div>
        </div>
    </header>
    <?php
        $min_price = $course->minimumPrice;
    ?>
    <footer class="item-footer">
        <!-- <div>
            <div class="item-label"><?= Yii::t('frontend','Course Name') ?></div>
            <div></div>
            <div><small> <?=  SchoolCourse::ListLevels()[$course->required_level] ?></small></div>
        </div> -->
