...
<section class="slider">
	...
	<div class="slides" data-slider="slick" data-slick='{"autoplay":true, "autoplaySpeed":3000, "fade":true, "arrows":false, "dots":true}'>
		<div class="slide slide--1" style="background-image:url('/dist/img/slider/1.jpg')">
			<div class="container">
		...
		<div class="slide slide--2" style="background-image:url('/dist/img/slider/2.jpg')">
			<div class="container">
				<div class="slide-content">
					<h1 class="bigger-text shadow-sm">Looking for the best <br>Education experience</h1>
					<h4 class="big-text mtmd shadow-sm">Check out our Exclusive offers</h4>
		...
		<div class="slide slide--3" style="background-image:url('/dist/img/slider/3.jpg')">
			<div class="container">
				<div class="slide-content">
					<h1 class="bigger-text shadow-sm">Looking for the best <br>Education experience</h1>
					<h4 class="big-text mtmd shadow-sm">Check out our Exclusive offers</h4>
