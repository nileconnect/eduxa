    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-7">
                ...
                <h5>
                    <div class="rating fr">
                        <div class="jq_rating jq-stars" data-options='{"initialRating":<?= $universityObj->total_rating ?>, "readOnly":true, "starSize":19}'></div>
                        <span class="text-muted">(<?= $universityObj->total_rating ?>)</span>
                    </div>
                                    ...
                                    foreach ($universityObj->universityVideos as $universityVideo) {
                                        ...
                                        <div class="col-sm-6 mbsm">
                                            <div class="embed-responsive embed-responsive-16by9">
                                                <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/<?= $universityVideo->base_url?>" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
