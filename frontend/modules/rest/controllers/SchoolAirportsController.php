...
use frontend\modules\rest\resources\SchoolAirportsResourse;
use yii\data\ActiveDataProvider;

class SchoolAirportsController extends ApiController
{
    public $modelClass = SchoolAirportsResourse::class;
