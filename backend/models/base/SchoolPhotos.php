...
/**
 * This is the base model class for table "school_photos".
 *
 * @property integer $id
 ...
 */
class SchoolPhotos extends \yii\db\ActiveRecord
{
    ...
    */
    ...
    /**
     * @inheritdoc
     * @return \backend\models\activequery\SchoolPhotosQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \backend\models\activequery\SchoolPhotosQuery(get_called_class());
    }
}
