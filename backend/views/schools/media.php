...
$this->title = Yii::t('backend', 'Schools Media');
...
$gridColumn = [
    ...
    [
        ...
        'value' => function ($model) {
            return '<a class="uploadBtn" data-fancybox="" data-type="iframe"   data-options=\'{"type" : "iframe", "iframe" : {"preload" : false, "css" : {"width" : "600px" , "height" : "400px" }}}\'  href="/schools/update-logo?id=' . $model->id . '">
