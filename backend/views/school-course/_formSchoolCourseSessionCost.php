...
//            'before' => false,
//            'footer' => false,
//            'after' => Html::button('<i class="glyphicon glyphicon-plus"></i>' . Yii::t('backend', 'Add Session Cost'), ['type' => 'button', 'class' => 'btn btn-success kv-batch-create', 'onClick' => 'addRowSchoolCourseSessionCost()']),
//        ]
//    ]
]);
echo  "    </div>\n\n";
