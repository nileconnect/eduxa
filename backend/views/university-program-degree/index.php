...
/* @var $searchModel backend\models\search\UniversityProgramDegreeSearch */
...
$this->title = Yii::t('backend', 'Program Degree');
...
<div class="university-program-degree-index">
    ...
    <?= GridView::widget([
        ...
        'columns' => $gridColumn,
        'pjax' => true,
        'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-university-program-degree']],
        'panel' => [
