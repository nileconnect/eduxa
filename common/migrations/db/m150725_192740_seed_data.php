...
class m150725_192740_seed_data extends Migration
{
    ...
    public function safeUp()
    {
        $this->insert('{{%user}}', [
            ...
            'password_hash' => Yii::$app->getSecurity()->generatePasswordHash('superadmin@321'),
        ...
        $this->insert('{{%user}}', [
            ...
            'password_hash' => Yii::$app->getSecurity()->generatePasswordHash('manager@321'),
            'auth_key' => Yii::$app->getSecurity()->generateRandomString(),
            'access_token' => Yii::$app->getSecurity()->generateRandomString(40),
            'status' => User::STATUS_ACTIVE,
            'created_at' => time(),
        ...
        $this->insert('{{%user}}', [
            ...
            'password_hash' => Yii::$app->getSecurity()->generatePasswordHash('user@321'),
            'auth_key' => Yii::$app->getSecurity()->generateRandomString(),
            'access_token' => Yii::$app->getSecurity()->generateRandomString(40),
            'status' => User::STATUS_ACTIVE,
            'created_at' => time(),
